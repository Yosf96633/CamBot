      ...
      <div className="absolute inset-0 z-10 flex items-center justify-center text-center px-4">
        ...
        >
          ...
          <p className=" italic font-extralight text-white text-lg max-w-5xl">
            ...
            Cambot reduces dependence on administrative desks and enhances
            self-service on campus.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center mt-6">
            <Link
              href="/login"
              className="px-4 py-1.5 text-white border border-white rounded-md hover:bg-white/10 transition-colors text-center"
            >
              Login
            </Link>
            <Link
              href="/signup"
              className="px-4 py-1.5 bg-white text-black rounded-md hover:bg-white/90 transition-colors text-center"
            >
              Sign Up
            </Link>
          </div>
